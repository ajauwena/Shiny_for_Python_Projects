...
--- Instructions ---
    ...
    3.  Execute "python3 master_script.py -in insurance_dataset.csv".
...
parser.add_argument('-in', '--in_file', action='store', dest='in_file', required=False, default='insurance_dataset.csv', help='Provide the name of the file containing the dataset of interest.')
